<div id="movies" class="container">
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Spider-Man: Homecoming</h3>
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Eternals</h3>
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Casino Royale</h3>
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Lord Of The Rings: Return Of The King</h3>
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Wonder Woman 1984</h3>
          ...
          <div class="movie-card">
            ...
            <div class="movie-card-body">
              <h3 class="movie-title">Captain Marvel</h3>
...
<button id="loadMore" class="conatiner">
    Load More!
</button>